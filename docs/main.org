...
:RESULTS:
 ...
 @@latex:\phantomsection@@  <<uWldRFMSnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
<<GpZYwPIs>> *Index:* *[c]* [[MF2y7jVW][create_documented_item_array]], [[bLwjt13w][create_documented_item_array_dir]] *[i]* [[tj9urqLx][initialize_boxing_module]] *[p]* [[nMrzFb5y][print_org_doc]] 
- @@latex:\phantomsection@@ *=create_documented_item_array=*  <<MF2y7jVW>> <<API_create_documented_item_array_filename>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:../src/documented_item.jl::91][documented_item.jl:91]], [[GpZYwPIs][back to index]]
...
#+END_QUOTE
[[file:../src/documented_item.jl::130][documented_item.jl:130]], [[GpZYwPIs][back to index]]
- @@latex:\phantomsection@@ *=create_documented_item_array_dir=*  <<bLwjt13w>> <<API_create_documented_item_array_dir>>
#+BEGIN_SRC julia :eval never :exports code
...
documented items.
#+END_QUOTE
[[file:../src/documented_item.jl::152][documented_item.jl:152]], [[GpZYwPIs][back to index]]
- @@latex:\phantomsection@@ *=initialize_boxing_module=*  <<tj9urqLx>> <<API_initialize_boxing_module>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_SRC
#+END_QUOTE
[[file:../src/evaluate.jl::18][evaluate.jl:18]], [[GpZYwPIs][back to index]]
- @@latex:\phantomsection@@ *=print_org_doc=*  <<nMrzFb5y>> <<API_print_org_doc_API>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:../src/main.jl::350][main.jl:350]], [[GpZYwPIs][back to index]]
:END:
...
#+INCLUDE: "../test/code_examples/enum.jl" src julia :eval never :exports code 
Add 
#+BEGIN_SRC julia :eval never :exports code 
