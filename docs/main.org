...
<<4Dl3iiI8>> *Index:* *[c]* [[4zqTWGfJ][create_documented_item_array]], [[emKJeMig][create_documented_item_array_dir]] *[i]* [[SyNpmZe3][initialize_boxing_module]] *[p]* [[IdUayqNe][print_org_doc]] 
- @@latex:\phantomsection@@ *=create_documented_item_array=*  <<4zqTWGfJ>> <<API_create_documented_item_array_filename>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:../src/documented_item.jl::89][documented_item.jl:89]], [[4Dl3iiI8][back to index]]
...
#+END_QUOTE
[[file:../src/documented_item.jl::128][documented_item.jl:128]], [[4Dl3iiI8][back to index]]
- @@latex:\phantomsection@@ *=create_documented_item_array_dir=*  <<emKJeMig>> <<API_create_documented_item_array_dir>>
#+BEGIN_SRC julia :eval never :exports code
...
documented items.
#+END_QUOTE
[[file:../src/documented_item.jl::150][documented_item.jl:150]], [[4Dl3iiI8][back to index]]
- @@latex:\phantomsection@@ *=initialize_boxing_module=*  <<SyNpmZe3>> <<API_initialize_boxing_module>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_SRC
#+END_QUOTE
[[file:../src/evaluate.jl::18][evaluate.jl:18]], [[4Dl3iiI8][back to index]]
- @@latex:\phantomsection@@ *=print_org_doc=*  <<IdUayqNe>> <<API_print_org_doc_API>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:../src/main.jl::346][main.jl:346]], [[4Dl3iiI8][back to index]]
:END:
...
:RESULTS:
 ...
 @@latex:\phantomsection@@  <<m7Bqca4bprint_org_doc_API>>
#+BEGIN_SRC julia :eval never :exports code
function print_org_doc(di_array::Array{Documented_Item,1};
                       tag::Union{String,Array{String,1}}="",
                       tag_to_ignore::Union{String,Array{String,1}}="",
