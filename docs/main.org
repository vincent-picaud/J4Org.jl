...
[[file:minimal_example/Foo.jl::46][Foo.jl:46]]
 @@latex:\phantomsection@@  <<GSlV6KBbnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
...
<<D0EhF3G3>> *Index:* *[f]* [[zzCYsR4c][foo]] *[n]* [[YbyC4AA5][norm]] 
- @@latex:\phantomsection@@ *=foo=*  <<zzCYsR4c>>
#+BEGIN_SRC julia :eval never :exports code
foo(r::Float64,p::Point)
#+END_SRC
#+BEGIN_QUOTE
...
#+END_QUOTE
[[file:minimal_example/Foo.jl::46][Foo.jl:46]], [[D0EhF3G3][back to index]]
- @@latex:\phantomsection@@ *=norm=*  <<YbyC4AA5>> <<HXIjusxXnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
See: _Point_struct_
#+END_QUOTE
[[file:minimal_example/Foo.jl::35][Foo.jl:35]], [[D0EhF3G3][back to index]]
:END:
...
<<EjebDg6K>> *Index:* *[f]* [[U3CUzoeJ][foo]] *[n]* [[vrc2Fk9g][norm]] 
***** *=foo=*  <<U3CUzoeJ>>
#+BEGIN_SRC julia :eval never :exports code
foo(r::Float64,p::Point)
#+END_SRC
...
#+END_QUOTE
[[file:minimal_example/Foo.jl::46][Foo.jl:46]], [[EjebDg6K][back to index]]
***** *=norm=*  <<vrc2Fk9g>> <<uHh8A5IEnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
See: _Point_struct_
#+END_QUOTE
[[file:minimal_example/Foo.jl::35][Foo.jl:35]], [[EjebDg6K][back to index]]
:END:
...
:RESULTS:
 ...
 @@latex:\phantomsection@@  <<43uaMtQLnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
:RESULTS:
 ...
 @@latex:\phantomsection@@  <<4wVNUrRPPoint_struct>>
#+BEGIN_SRC julia :eval never :exports code
struct Point
#+END_SRC
#+BEGIN_QUOTE
...
You can add any valid Org mode directive. If you want to use
in-documentation link, use [[4wVNUrRPnorm_link_example][norm(...)]]
#+END_QUOTE
[[file:minimal_example/Foo.jl::8][Foo.jl:8]]
 @@latex:\phantomsection@@  <<4wVNUrRPnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
See: [[4wVNUrRPPoint_struct][struct Point]]
#+END_QUOTE
[[file:minimal_example/Foo.jl::35][Foo.jl:35]]
:END:
...
<<xO0yfA2e>> *Index:* *[c]* [[RatBFaVH][create_documented_item_array]], [[SZOLWcdA][create_documented_item_array_dir]] *[i]* [[2mMt6HWE][initialize_boxing_module]] *[p]* [[qy74mfm8][print_org_doc]] 
- @@latex:\phantomsection@@ *=create_documented_item_array=*  <<RatBFaVH>> <<API_create_documented_item_array_filename>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:../src/documented_item.jl::91][documented_item.jl:91]], [[xO0yfA2e][back to index]]
...
#+END_QUOTE
[[file:../src/documented_item.jl::130][documented_item.jl:130]], [[xO0yfA2e][back to index]]
- @@latex:\phantomsection@@ *=create_documented_item_array_dir=*  <<SZOLWcdA>> <<API_create_documented_item_array_dir>>
#+BEGIN_SRC julia :eval never :exports code
...
documented items.
#+END_QUOTE
[[file:../src/documented_item.jl::152][documented_item.jl:152]], [[xO0yfA2e][back to index]]
- @@latex:\phantomsection@@ *=initialize_boxing_module=*  <<2mMt6HWE>> <<API_initialize_boxing_module>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_SRC
#+END_QUOTE
[[file:../src/evaluate.jl::18][evaluate.jl:18]], [[xO0yfA2e][back to index]]
- @@latex:\phantomsection@@ *=print_org_doc=*  <<qy74mfm8>> <<API_print_org_doc_API>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:../src/main.jl::346][main.jl:346]], [[xO0yfA2e][back to index]]
:END:
...
:RESULTS:
 ...
 @@latex:\phantomsection@@  <<1yuiOaSPprint_org_doc_API>>
#+BEGIN_SRC julia :eval never :exports code
function print_org_doc(di_array::Array{Documented_Item,1};
                       tag::Union{String,Array{String,1}}="",
                       tag_to_ignore::Union{String,Array{String,1}}="",
...
#+END_QUOTE
[[file:../src/main.jl::345][main.jl:345]]
:END:
