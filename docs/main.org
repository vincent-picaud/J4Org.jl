...
[[file:minimal_example/Foo.jl::46][Foo.jl:46]]
 @@latex:\phantomsection@@  <<8wSajN26norm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64 = sqrt(p.x*p.x+p.y*p.y
#+END_SRC
#+BEGIN_QUOTE
...
print_org_doc(documented_items,boxingModule="J4OrgBoxing",tag="API",header_level=0,link_prefix="API_",with_body=true)
#+END_SRC

#+RESULTS:
:RESULTS:
WARNING: Method definition extract_function(Array{Tokenize.Tokens.Token, 1}, Int64) in module J4Org at /home/picaud/GitHub/J4Org.jl/src/extract.jl:96 overwritten at /home/picaud/GitHub/J4Org.jl/src/extract.jl:96.
<<dPpe6bcP>> *Index:* *[c]* [[BvuZRjhj][create_documented_item_array]], [[fB9GJRnY][create_documented_item_array_dir]] *[i]* [[PuyNqvGv][initialize_boxing_module]] *[p]* [[nw3ZyjtW][print_org_doc]] 
- @@latex:\phantomsection@@ *=create_documented_item_array=*  <<BvuZRjhj>> <<API_create_documented_item_array_filename>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:../src/documented_item.jl::97][documented_item.jl:97]], [[dPpe6bcP][back to index]]
...
#+END_QUOTE
[[file:../src/documented_item.jl::142][documented_item.jl:142]], [[dPpe6bcP][back to index]]
- @@latex:\phantomsection@@ *=create_documented_item_array_dir=*  <<fB9GJRnY>> <<API_create_documented_item_array_dir>>
#+BEGIN_SRC julia :eval never :exports code
...
documented items.
#+END_QUOTE
[[file:../src/documented_item.jl::189][documented_item.jl:189]], [[dPpe6bcP][back to index]]
- @@latex:\phantomsection@@ *=initialize_boxing_module=*  <<PuyNqvGv>> <<API_initialize_boxing_module>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_SRC
#+END_QUOTE
[[file:../src/evaluate.jl::18][evaluate.jl:18]], [[dPpe6bcP][back to index]]
- @@latex:\phantomsection@@ *=print_org_doc=*  <<nw3ZyjtW>> <<API_print_org_doc_API>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:../src/main.jl::359][main.jl:359]], [[dPpe6bcP][back to index]]
:END:
