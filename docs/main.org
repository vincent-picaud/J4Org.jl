...
#+TITLE: (Self-)Documentation of the J4Org.jl Package
...
*** TODO Improving exported document style [0/1]
...
- [ ] TODO provide more details about customization, for the moment
  you can have a look at [[https://github.com/vincent-picaud/Julia_with_OrgMode_Example][github: Julia_with_OrgMode_Example]]
...
- *l>0* create subsection of level *l*, for instance *header_level=3*
  creates subsections beginning with *3* stars. See [[id:0f6a49dc-ee9f-4964-8801-8badfb67f735][header_level=5]].
...
[[file:minimal_example/Foo.jl::42][Foo.jl:42]]
 @@latex:\phantomsection@@  <<6NMUOTNGnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
...
# =WARNING:= Link target ("Point_struct", "") not found
<<MOdp26jo>> *Index:* *[f]* [[6T7mWmH8][foo]] *[n]* [[2eMRib40][norm]] 
- @@latex:\phantomsection@@ *=foo=*  <<6T7mWmH8>>
#+BEGIN_SRC julia :eval never :exports code
foo(r::Float64,p::Point)
#+END_SRC
#+BEGIN_QUOTE
...
#+END_SRC
#+END_QUOTE
[[file:minimal_example/Foo.jl::42][Foo.jl:42]], [[MOdp26jo][back to index]]
- @@latex:\phantomsection@@ *=norm=*  <<2eMRib40>> <<KGerKtxUnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
See: _Point_struct_
#+END_QUOTE
[[file:minimal_example/Foo.jl::31][Foo.jl:31]], [[MOdp26jo][back to index]]
:END:
...
# =WARNING:= Link target ("Point_struct", "") not found
<<Fnuec4dG>> *Index:* *[f]* [[Ygi2UuWU][foo]] *[n]* [[wmjf1rQB][norm]] 
***** *=foo=*  <<Ygi2UuWU>>
#+BEGIN_SRC julia :eval never :exports code
foo(r::Float64,p::Point)
#+END_SRC
...
#+END_SRC
#+END_QUOTE
[[file:minimal_example/Foo.jl::42][Foo.jl:42]], [[Fnuec4dG][back to index]]
***** *=norm=*  <<wmjf1rQB>> <<gYEa51ginorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
See: _Point_struct_
#+END_QUOTE
[[file:minimal_example/Foo.jl::31][Foo.jl:31]], [[Fnuec4dG][back to index]]
:END:
...
# =WARNING:= Link target ("Point_struct", "") not found
 @@latex:\phantomsection@@  <<MUvmN4JXnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
:RESULTS:
 ...
 @@latex:\phantomsection@@  <<Miryi32RPoint_struct>>
#+BEGIN_SRC julia :eval never :exports code
struct Point
#+END_SRC
#+BEGIN_QUOTE
...
You can add any valid Org mode directive. If you want to use
in-documentation link, use [[Miryi32Rnorm_link_example][norm(...)]]
#+END_QUOTE
[[file:minimal_example/Foo.jl::8][Foo.jl:8]]
 @@latex:\phantomsection@@  <<Miryi32Rnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
See: [[Miryi32RPoint_struct][struct Point]]
#+END_QUOTE
[[file:minimal_example/Foo.jl::31][Foo.jl:31]]
:END:
...
print_org_doc(documented_items,boxingModule="J4OrgBoxing",tag="API",header_level=2,link_prefix="API_")
#+END_SRC

#+RESULTS:
:RESULTS:

<<1hsaCwUX>> *Index:* *[c]* [[KoYAb5Ql][create_documented_item_array]], [[wtaVuaiF][create_documented_item_array_dir]] *[i]* [[gmTuFeZA][initialize_boxing_module]] *[p]* [[nC1kfeoL][print_org_doc]] 
** *=create_documented_item_array=*  <<KoYAb5Ql>> <<API_create_documented_item_array_filename>>
#+BEGIN_SRC julia :eval never :exports code
...
See: [[API_create_documented_item_array_directory][create_documented_item_array_dir(...)]]
#+END_QUOTE
[[file:/home/picaud/GitLab/PVBibliography/Julia/MyLocalPackages/J4Org/src/documented_item.jl::89][documented_item.jl:89]], [[1hsaCwUX][back to index]]
...
See: [[API_create_documented_item_array_directory][create_documented_item_array_dir(...)]]
#+END_QUOTE
[[file:/home/picaud/GitLab/PVBibliography/Julia/MyLocalPackages/J4Org/src/documented_item.jl::130][documented_item.jl:130]], [[1hsaCwUX][back to index]]
** *=create_documented_item_array_dir=*  <<wtaVuaiF>> <<API_create_documented_item_array_directory>>
#+BEGIN_SRC julia :eval never :exports code
...
documented items.
#+END_QUOTE
[[file:/home/picaud/GitLab/PVBibliography/Julia/MyLocalPackages/J4Org/src/documented_item.jl::150][documented_item.jl:150]], [[1hsaCwUX][back to index]]
** *=initialize_boxing_module=*  <<gmTuFeZA>> <<API_initialize_boxing_module>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_SRC
#+BEGIN_QUOTE
Initializes a boxing module. This module is used to run Julia comment
code snippets (code comments starting by "#!")
...
See: [[API_print_org_doc_API][print_org_doc(...)]]
#+END_QUOTE
[[file:/home/picaud/GitLab/PVBibliography/Julia/MyLocalPackages/J4Org/src/evaluate.jl::17][evaluate.jl:17]], [[1hsaCwUX][back to index]]
** *=print_org_doc=*  <<nC1kfeoL>> <<API_print_org_doc_API>>
#+BEGIN_SRC julia :eval never :exports code
...
- *identifier*: generate documentation for this "identifier".
  Can be a function name, a structure name, etc... 
- *link_prefix*: allows to add a prefix to extra link (#+tag    L:extra_link).
...
#+END_QUOTE
[[file:/home/picaud/GitLab/PVBibliography/Julia/MyLocalPackages/J4Org/src/main.jl::346][main.jl:346]], [[1hsaCwUX][back to index]]
:END:
