...
[[file:minimal_example/Foo.jl::46][Foo.jl:46]]
 @@latex:\phantomsection@@  <<yhPEdQtTnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
...
<<jyjOXGEO>> *Index:* *[f]* [[JgRUGz0s][foo]] *[n]* [[KyAt2C8w][norm]] 
- @@latex:\phantomsection@@ *=foo=*  <<JgRUGz0s>>
#+BEGIN_SRC julia :eval never :exports code
foo(r::Float64,p::Point)
#+END_SRC
#+BEGIN_QUOTE
...
#+END_SRC
#+END_QUOTE
[[file:minimal_example/Foo.jl::46][Foo.jl:46]], [[jyjOXGEO][back to index]]
- @@latex:\phantomsection@@ *=norm=*  <<KyAt2C8w>> <<FNCqEBEwnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
See: _struct Point_
#+END_QUOTE
[[file:minimal_example/Foo.jl::35][Foo.jl:35]], [[jyjOXGEO][back to index]]
:END:
...
<<I2o1QN1K>> *Index:* *[f]* [[wrfzf1LI][foo]] *[n]* [[RpQo2xJK][norm]] 
***** *=foo=*  <<wrfzf1LI>>
#+BEGIN_SRC julia :eval never :exports code
foo(r::Float64,p::Point)
#+END_SRC
...
#+END_SRC
#+END_QUOTE
[[file:minimal_example/Foo.jl::46][Foo.jl:46]], [[I2o1QN1K][back to index]]
***** *=norm=*  <<RpQo2xJK>> <<xvGW5wHynorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
See: _struct Point_
#+END_QUOTE
[[file:minimal_example/Foo.jl::35][Foo.jl:35]], [[I2o1QN1K][back to index]]
:END:
...
:RESULTS:
 ...
 @@latex:\phantomsection@@  <<xtQNAsSBnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
:RESULTS:
 ...
 @@latex:\phantomsection@@  <<kiZRi0AqPoint_struct>>
#+BEGIN_SRC julia :eval never :exports code
struct Point
#+END_SRC
#+BEGIN_QUOTE
...
You can add any valid Org mode directive. If you want to use
in-documentation link, use [[kiZRi0Aqnorm_link_example][norm(...)]]
#+END_QUOTE
[[file:minimal_example/Foo.jl::8][Foo.jl:8]]
 @@latex:\phantomsection@@  <<kiZRi0Aqnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
See: [[kiZRi0AqPoint_struct][struct Point]]
#+END_QUOTE
[[file:minimal_example/Foo.jl::35][Foo.jl:35]]
:END:
...
<<ERirR9ro>> *Index:* *[c]* [[vgnLV5Rd][create_documented_item_array]], [[ENlO21eb][create_documented_item_array_dir]] *[i]* [[ItsdGG8b][initialize_boxing_module]] *[p]* [[KTgNkTo8][print_org_doc]] 
- @@latex:\phantomsection@@ *=create_documented_item_array=*  <<vgnLV5Rd>> <<API_create_documented_item_array_filename>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:../src/documented_item.jl::91][documented_item.jl:91]], [[ERirR9ro][back to index]]
...
#+END_QUOTE
[[file:../src/documented_item.jl::130][documented_item.jl:130]], [[ERirR9ro][back to index]]
- @@latex:\phantomsection@@ *=create_documented_item_array_dir=*  <<ENlO21eb>> <<API_create_documented_item_array_dir>>
#+BEGIN_SRC julia :eval never :exports code
...
documented items.
#+END_QUOTE
[[file:../src/documented_item.jl::152][documented_item.jl:152]], [[ERirR9ro][back to index]]
- @@latex:\phantomsection@@ *=initialize_boxing_module=*  <<ItsdGG8b>> <<API_initialize_boxing_module>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_SRC
#+END_QUOTE
[[file:../src/evaluate.jl::18][evaluate.jl:18]], [[ERirR9ro][back to index]]
- @@latex:\phantomsection@@ *=print_org_doc=*  <<KTgNkTo8>> <<API_print_org_doc_API>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:../src/main.jl::348][main.jl:348]], [[ERirR9ro][back to index]]
:END:
...
:RESULTS:
 ...
 @@latex:\phantomsection@@  <<YdODhLT2print_org_doc_API>>
#+BEGIN_SRC julia :eval never :exports code
function print_org_doc(di_array::Array{Documented_Item,1};
                       tag::Union{String,Array{String,1}}="",
                       tag_to_ignore::Union{String,Array{String,1}}="",
...
#+END_QUOTE
[[file:../src/main.jl::348][main.jl:348]]
:END:
...
#+RESULTS:
#+begin_example
extract_links: Error During Test
  Got an exception of type MethodError outside of a @test
  MethodError: Cannot `convert` an object of type SubString{String} to an object of type Tuple{String,String}
  This may have arisen from a call to the constructor Tuple{String,String}(...),
  since type constructors fall back to convert methods.
  Stacktrace:
   [1] push!(::Array{Tuple{String,String},1}, ::SubString{String}) at ./array.jl:651
   [2] extract_links(::String) at /home/picaud/GitHub/J4Org.jl/src/links.jl:45
   [3] macro expansion at /home/picaud/GitHub/J4Org.jl/test/links.jl:9 [inlined]
   [4] macro expansion at ./test.jl:860 [inlined]
   [5] anonymous at ./<missing>:?
   [6] include_from_node1(::String) at ./loading.jl:576
   [7] include(::String) at ./sysimg.jl:14
   [8] macro expansion at /home/picaud/GitHub/J4Org.jl/test/runtests.jl:16 [inlined]
   ...
   [15] macro expansion at /home/picaud/.julia/v0.6/Revise/src/Revise.jl:775 [inlined]
   [16] (::Revise.##17#18{Base.REPL.REPLBackend})() at ./event.jl:73
real_code_with_link: Error During Test
  Got an exception of type MethodError outside of a @test
  MethodError: Cannot `convert` an object of type SubString{String} to an object of type Tuple{String,String}
  This may have arisen from a call to the constructor Tuple{String,String}(...),
  since type constructors fall back to convert methods.
  Stacktrace:
   [1] push!(::Array{Tuple{String,String},1}, ::SubString{String}) at ./array.jl:651
   [2] extract_links(::String) at /home/picaud/GitHub/J4Org.jl/src/links.jl:45
   [3] extract_links at /home/picaud/GitHub/J4Org.jl/src/links.jl:60 [inlined]
   [4] check_for_link_error(::Array{J4Org.Documented_Item,1}, ::Array{J4Org.Documented_Item,1}) at /home/picaud/GitHub/J4Org.jl/src/links.jl:119
   [5] #org_string_documented_item#56(::String, ::Bool, ::String, ::String, ::Int64, ::String, ::Function, ::J4Org.Documented_Item, ::Array{J4Org.Documented_Item,1}, ::Array{J4Org.Documented_Item,1}) at /home/picaud/GitHub/J4Org.jl/src/main.jl:85
   [6] (::J4Org.#kw##org_string_documented_item)(::Array{Any,1}, ::J4Org.#org_string_documented_item, ::J4Org.Documented_Item, ::Array{J4Org.Documented_Item,1}, ::Array{J4Org.Documented_Item,1}) at ./<missing>:0
   [7] #org_string_documented_item_array#50(::Int64, ::String, ::Bool, ::Bool, ::String, ::Function, ::Array{J4Org.Documented_Item,1}, ::J4Org.#predicate#48{String,String,String}) at /home/picaud/GitHub/J4Org.jl/src/main.jl:297
   [8] (::J4Org.#kw##org_string_documented_item_array)(::Array{Any,1}, ::J4Org.#org_string_documented_item_array, ::Array{J4Org.Documented_Item,1}, ::Function) at ./<missing>:0
   [9] #org_string_documented_item_array#47(::String, ::String, ::String, ::Int64, ::String, ::Bool, ::Bool, ::String, ::J4Org.#org_string_documented_item_array, ::Array{J4Org.Documented_Item,1}) at /home/picaud/GitHub/J4Org.jl/src/main.jl:339
   [10] (::J4Org.#kw##org_string_documented_item_array)(::Array{Any,1}, ::J4Org.#org_string_documented_item_array, ::Array{J4Org.Documented_Item,1}) at ./<missing>:0
   [11] macro expansion at /home/picaud/GitHub/J4Org.jl/test/real_code.jl:6 [inlined]
   [12] macro expansion at ./test.jl:860 [inlined]
   [13] anonymous at ./<missing>:?
   [14] include_from_node1(::String) at ./loading.jl:576
   [15] include(::String) at ./sysimg.jl:14
   [16] macro expansion at /home/picaud/GitHub/J4Org.jl/test/runtests.jl:19 [inlined]
   ...
   [22] eval_user_input(::Any, ::Base.REPL.REPLBackend) at ./REPL.jl:66
   [23] macro expansion at /home/picaud/.julia/v0.6/Revise/src/Revise.jl:775 [inlined]
   [24] (::Revise.##17#18{Base.REPL.REPLBackend})() at ./event.jl:73
code_1: Error During Test
  Test threw an exception of type MethodError
  Expression: org_string_documented_item(di, [di], [di]) == "- @@latex:\\phantomsection@@ *=myFunction=* \n#+BEGIN_SRC julia :eval never :exports code\nfunction myFunction (;x::Float64=sin(1))\n#+END_SRC\n#+BEGIN_QUOTE\nMy documentedItem\n\nline 2\n#+END_QUOTE\n\n"
  MethodError: Cannot `convert` an object of type Void to an object of type Bool
  This may have arisen from a call to the constructor Bool(...),
  since type constructors fall back to convert methods.
  Stacktrace:
   [1] check_for_link_error(::Array{J4Org.Documented_Item,1}, ::Array{J4Org.Documented_Item,1}) at /home/picaud/GitHub/J4Org.jl/src/links.jl:136
   [2] #org_string_documented_item#56(::String, ::Bool, ::String, ::String, ::Int64, ::String, ::Function, ::J4Org.Documented_Item, ::Array{J4Org.Documented_Item,1}, ::Array{J4Org.Documented_Item,1}) at /home/picaud/GitHub/J4Org.jl/src/main.jl:85
   [3] macro expansion at /home/picaud/GitHub/J4Org.jl/test/runtests.jl:53 [inlined]
   [4] macro expansion at ./test.jl:860 [inlined]
   [5] macro expansion at /home/picaud/GitHub/J4Org.jl/test/runtests.jl:45 [inlined]
...
J4Org                              |   92      3     95
  openclose                        |    6             6
  skip_identifier                  |    6             6
  skip_comma_separated_identifiers |    5             5
  skip_where_block                 |    2             2
  skip_declaration_block           |    3             3
  is_abstract_and_is_type          |    2             2
  is_enum                          |    1             1
  extract_comment                  |    4             4
  extract_comment_tab              |    4             4
  function_1                       |    2             2
  function_2                       |    2             2
  function_3                       |    2             2
  function_1_short                 |    2             2
  function_2_short                 |    2             2
  function_3_short                 |    2             2
  struct_1                         |    2             2
  struct_2                         |    2             2
  struct_3                         |    2             2
  export                           |    2             2
  ...
  find_tag                         |    3             3
  extract_links                    |    1      1      2
  extract_links                    |              No tests
  extract_links_full               |    1             1
  extract_links_full               |    1             1
  documented_item                  |              No tests
  di_real_code_1                   |    4             4
  di_real_code_problematic_1       |              No tests
  real_code_with_link              |           1      1
  code_1                           |    4      1      5
ERROR: LoadError: Some tests did not pass: 92 passed, 0 failed, 3 errored, 0 broken.
while loading /home/picaud/GitHub/J4Org.jl/test/runtests.jl, in expression starting on line 5
#+end_example
