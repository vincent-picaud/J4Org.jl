...
using Revise
using J4Org
initialize_boxing_module(usedModules=["J4Org"],force=true)
#+END_SRC

# Also use Foo as example 
#+BEGIN_SRC julia :results output none :eval no-export :exports none
push!(LOAD_PATH,pwd()*"/minimal_example/")
initialize_boxing_module(boxingModule="FooBoxing",usedModules=["Foo"],force=true)
#+END_SRC
...
#+BEGIN_SRC org -j -n :tangle :tangle minimal_example/foo.org 
,#+PROPERTY: header-args:julia :session *my_session* :exports code :eval no-export
,#+OPTIONS: ^:{}
,#+TITLE: Getting Started with a minimal example

,#+BEGIN_SRC julia :results output none :eval no-export :exports none
push!(LOAD_PATH,pwd()) # (ref:module_location)
,#+END_SRC

,#+BEGIN_SRC julia :results output none :eval no-export :exports none
using J4Org # (ref:using_J4Org)
initialize_boxing_module(usedModules=["Foo"]) # (ref:boxing)
...
- [[(module_location)]] tells Julia where it can find our local =Foo=
  module. This statement is only required if the documented module is
  in an unusual place.

- [[(using_J4Org)]] uses this package

- [[(boxing)]] defines what are the module to use when executing Julia
  code extracted from the doc (the "#!" statements). Here we are
  documenting the =Foo= module, hence we must use it. Note that you
  can also use extra module for instance with =["Foo", "ExtraModule",
  ...]=. See [[API_initialize_boxing_module][initialize_boxing_module]] for further details
...
print_org_doc(documented_items,tag="API",header_level=0,link_prefix="API_")
#+END_SRC

#+RESULTS:
:RESULTS:

<<JTjbLb9P>> *Index:* *[c]* [[4gN2iSbb][create_documented_item_array]], [[ccQ8yE3U][create_documented_item_array_dir]] *[e]* [[80BigUqU][export]] *[i]* [[8znoAhf3][initialize_boxing_module]] *[p]* [[jxMC3IVR][print_org_doc]] 
- @@latex:\phantomsection@@ *=create_documented_item_array=*  <<4gN2iSbb>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:/home/picaud/GitLab/PVBibliography/Julia/MyLocalPackages/J4Org/src/documented_item.jl::89][documented_item.jl:89]], [[JTjbLb9P][back to index]]
...
#+END_SRC
#+END_QUOTE
[[file:/home/picaud/GitLab/PVBibliography/Julia/MyLocalPackages/J4Org/src/documented_item.jl::128][documented_item.jl:128]], [[JTjbLb9P][back to index]]
- @@latex:\phantomsection@@ *=create_documented_item_array_dir=*  <<ccQ8yE3U>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:/home/picaud/GitLab/PVBibliography/Julia/MyLocalPackages/J4Org/src/documented_item.jl::147][documented_item.jl:147]], [[JTjbLb9P][back to index]]
- @@latex:\phantomsection@@ *=export=*  <<80BigUqU>>
#+BEGIN_SRC julia :eval never :exports code
...
Exported symbols
#+END_QUOTE
[[file:/home/picaud/GitLab/PVBibliography/Julia/MyLocalPackages/J4Org/src/J4Org.jl::3][J4Org.jl:3]], [[JTjbLb9P][back to index]]
- @@latex:\phantomsection@@ *=initialize_boxing_module=*  <<8znoAhf3>> <<API_initialize_boxing_module>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:/home/picaud/GitLab/PVBibliography/Julia/MyLocalPackages/J4Org/src/evaluate.jl::17][evaluate.jl:17]], [[JTjbLb9P][back to index]]
- @@latex:\phantomsection@@ *=print_org_doc=*  <<jxMC3IVR>> <<API_print_org_doc_API>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:/home/picaud/GitLab/PVBibliography/Julia/MyLocalPackages/J4Org/src/main.jl::346][main.jl:346]], [[JTjbLb9P][back to index]]
:END:
