...
[[file:minimal_example/Foo.jl::46][Foo.jl:46]]
 @@latex:\phantomsection@@  <<AA92hulPnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
...
Foo.Point(1.0, 2.0)
Foo.Point(2.0, 4.0)
ERROR: MethodError: no method matching start(::Foo.Point)
Closest candidates are:
  start(!Matched::SimpleVector) at essentials.jl:258
  start(!Matched::Base.MethodList) at reflection.jl:560
  start(!Matched::ExponentialBackOff) at error.jl:107
  ...
Stacktrace:
 [1] #writedlm#18(::Array{Any,1}, ::Function, ::IOStream, ::Foo.Point, ::Char) at ./datafmt.jl:673
 [2] #20 at ./datafmt.jl:683 [inlined]
 [3] open(::Base.DataFmt.##20#21{Array{Any,1},Foo.Point,Char}, ::String, ::String) at ./iostream.jl:152
 [4] #writecsv#23(::Array{Any,1}, ::Function, ::String, ::Foo.Point) at ./datafmt.jl:705
 [5] writecsv(::String, ::Foo.Point) at ./datafmt.jl:705
...
# =WARNING:= Link target ("Point_struct", "") not found
<<zUy73F4s>> *Index:* *[f]* [[Jz0S06pw][foo]] *[n]* [[NVi3CW2B][norm]] 
- @@latex:\phantomsection@@ *=foo=*  <<Jz0S06pw>>
#+BEGIN_SRC julia :eval never :exports code
foo(r::Float64,p::Point)
#+END_SRC
#+BEGIN_QUOTE
...
#+END_QUOTE
[[file:minimal_example/Foo.jl::46][Foo.jl:46]], [[zUy73F4s][back to index]]
- @@latex:\phantomsection@@ *=norm=*  <<NVi3CW2B>> <<dKFdSpMAnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
See: _Point_struct_
#+END_QUOTE
[[file:minimal_example/Foo.jl::35][Foo.jl:35]], [[zUy73F4s][back to index]]
:END:
...
# =WARNING:= Link target ("Point_struct", "") not found
<<J2SFQ4TY>> *Index:* *[f]* [[XpMIuHRz][foo]] *[n]* [[T6Z1pyra][norm]] 
***** *=foo=*  <<XpMIuHRz>>
#+BEGIN_SRC julia :eval never :exports code
foo(r::Float64,p::Point)
#+END_SRC
...
#+END_QUOTE
[[file:minimal_example/Foo.jl::46][Foo.jl:46]], [[J2SFQ4TY][back to index]]
***** *=norm=*  <<T6Z1pyra>> <<AQYBWXbEnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
See: _Point_struct_
#+END_QUOTE
[[file:minimal_example/Foo.jl::35][Foo.jl:35]], [[J2SFQ4TY][back to index]]
:END:
...
# =WARNING:= Link target ("Point_struct", "") not found
 @@latex:\phantomsection@@  <<mohjDaXSnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
2.23606797749979
 ...
 @@latex:\phantomsection@@  <<muX5n8b2Point_struct>>
#+BEGIN_SRC julia :eval never :exports code
struct Point
#+END_SRC
#+BEGIN_QUOTE
...
You can add any valid Org mode directive. If you want to use
in-documentation link, use [[muX5n8b2norm_link_example][norm(...)]]
#+END_QUOTE
[[file:minimal_example/Foo.jl::8][Foo.jl:8]]
 @@latex:\phantomsection@@  <<muX5n8b2norm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
See: [[muX5n8b2Point_struct][struct Point]]
#+END_QUOTE
[[file:minimal_example/Foo.jl::35][Foo.jl:35]]
:END:
...
<<ZhNQjTtI>> *Index:* *[c]* [[pKgqfE8k][create_documented_item_array]], [[0ye9zUqo][create_documented_item_array_dir]] *[i]* [[YjPYM9uI][initialize_boxing_module]] *[p]* [[2qXRWMY3][print_org_doc]] 
- @@latex:\phantomsection@@ *=create_documented_item_array=*  <<pKgqfE8k>> <<API_create_documented_item_array_filename>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:../src/documented_item.jl::91][documented_item.jl:91]], [[ZhNQjTtI][back to index]]
...
#+END_QUOTE
[[file:../src/documented_item.jl::130][documented_item.jl:130]], [[ZhNQjTtI][back to index]]
- @@latex:\phantomsection@@ *=create_documented_item_array_dir=*  <<0ye9zUqo>> <<API_create_documented_item_array_dir>>
#+BEGIN_SRC julia :eval never :exports code
...
documented items.
#+END_QUOTE
[[file:../src/documented_item.jl::152][documented_item.jl:152]], [[ZhNQjTtI][back to index]]
- @@latex:\phantomsection@@ *=initialize_boxing_module=*  <<YjPYM9uI>> <<API_initialize_boxing_module>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_SRC
#+END_QUOTE
[[file:../src/evaluate.jl::18][evaluate.jl:18]], [[ZhNQjTtI][back to index]]
- @@latex:\phantomsection@@ *=print_org_doc=*  <<2qXRWMY3>> <<API_print_org_doc_API>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:../src/main.jl::346][main.jl:346]], [[ZhNQjTtI][back to index]]
:END:
...
# =WARNING:= Link target ("initialize_boxing_module", "") not found
 @@latex:\phantomsection@@  <<GQntAMCoprint_org_doc_API>>
#+BEGIN_SRC julia :eval never :exports code
function print_org_doc(di_array::Array{Documented_Item,1};
                       tag::Union{String,Array{String,1}}="",
                       tag_to_ignore::Union{String,Array{String,1}}="",
