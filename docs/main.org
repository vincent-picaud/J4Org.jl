...
[[file:minimal_example/Foo.jl::42][Foo.jl:42]]
 @@latex:\phantomsection@@  <<GMKhRdiFnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
...
# =WARNING:= Link target ("Point_struct", "") not found
<<9DmFzSP8>> *Index:* *[f]* [[5X3b2pMe][foo]] *[n]* [[lC2oGf3j][norm]] 
- @@latex:\phantomsection@@ *=foo=*  <<5X3b2pMe>>
#+BEGIN_SRC julia :eval never :exports code
foo(r::Float64,p::Point)
#+END_SRC
#+BEGIN_QUOTE
...
#+END_SRC
#+END_QUOTE
[[file:minimal_example/Foo.jl::42][Foo.jl:42]], [[9DmFzSP8][back to index]]
- @@latex:\phantomsection@@ *=norm=*  <<lC2oGf3j>> <<Mvnscf3dnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
See: _Point_struct_
#+END_QUOTE
[[file:minimal_example/Foo.jl::31][Foo.jl:31]], [[9DmFzSP8][back to index]]
:END:
...
# =WARNING:= Link target ("Point_struct", "") not found
<<kxVWBf1C>> *Index:* *[f]* [[mO1O71AO][foo]] *[n]* [[AgGeysXM][norm]] 
***** *=foo=*  <<mO1O71AO>>
#+BEGIN_SRC julia :eval never :exports code
foo(r::Float64,p::Point)
#+END_SRC
...
#+END_SRC
#+END_QUOTE
[[file:minimal_example/Foo.jl::42][Foo.jl:42]], [[kxVWBf1C][back to index]]
***** *=norm=*  <<AgGeysXM>> <<B4VCq5ainorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
See: _Point_struct_
#+END_QUOTE
[[file:minimal_example/Foo.jl::31][Foo.jl:31]], [[kxVWBf1C][back to index]]
:END:
...
# =WARNING:= Link target ("Point_struct", "") not found
 @@latex:\phantomsection@@  <<Q1Sqm9nGnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
:RESULTS:
 ...
 @@latex:\phantomsection@@  <<IymsBnvIPoint_struct>>
#+BEGIN_SRC julia :eval never :exports code
struct Point
#+END_SRC
#+BEGIN_QUOTE
...
You can add any valid Org mode directive. If you want to use
in-documentation link, use [[IymsBnvInorm_link_example][norm(...)]]
#+END_QUOTE
[[file:minimal_example/Foo.jl::8][Foo.jl:8]]
 @@latex:\phantomsection@@  <<IymsBnvInorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
norm(p::Point)::Float64
#+END_SRC
#+BEGIN_QUOTE
...
See: [[IymsBnvIPoint_struct][struct Point]]
#+END_QUOTE
[[file:minimal_example/Foo.jl::31][Foo.jl:31]]
:END:
...
<<sc1zv94h>> *Index:* *[c]* [[ZLmVoyWk][create_documented_item_array]], [[5Eg8CYXp][create_documented_item_array_dir]] *[i]* [[sCy0j0YO][initialize_boxing_module]] *[p]* [[4meIsN4c][print_org_doc]] 
- @@latex:\phantomsection@@ *=create_documented_item_array=*  <<ZLmVoyWk>> <<API_create_documented_item_array_filename>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:../src/documented_item.jl::89][documented_item.jl:89]], [[sc1zv94h][back to index]]
...
#+END_QUOTE
[[file:../src/documented_item.jl::128][documented_item.jl:128]], [[sc1zv94h][back to index]]
- @@latex:\phantomsection@@ *=create_documented_item_array_dir=*  <<5Eg8CYXp>> <<API_create_documented_item_array_dir>>
#+BEGIN_SRC julia :eval never :exports code
...
documented items.
#+END_QUOTE
[[file:../src/documented_item.jl::150][documented_item.jl:150]], [[sc1zv94h][back to index]]
- @@latex:\phantomsection@@ *=initialize_boxing_module=*  <<sCy0j0YO>> <<API_initialize_boxing_module>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_SRC
#+END_QUOTE
[[file:../src/evaluate.jl::18][evaluate.jl:18]], [[sc1zv94h][back to index]]
- @@latex:\phantomsection@@ *=print_org_doc=*  <<4meIsN4c>> <<API_print_org_doc_API>>
#+BEGIN_SRC julia :eval never :exports code
...
#+END_QUOTE
[[file:../src/main.jl::346][main.jl:346]], [[sc1zv94h][back to index]]
:END:
...
# =WARNING:= Link target ("initialize_boxing_module", "") not found
 @@latex:\phantomsection@@  <<OaY7rdLXprint_org_doc_API>>
#+BEGIN_SRC julia :eval never :exports code
function print_org_doc(di_array::Array{Documented_Item,1};
                       tag::Union{String,Array{String,1}}="",
                       tag_to_ignore::Union{String,Array{String,1}}="",
