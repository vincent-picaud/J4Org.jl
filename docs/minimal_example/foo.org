...
#+RESULTS:
:RESULTS:
<<KI1L4RUf>> *Index:* *[A]* [[UHWJli9e][Alpha]] *[P]* [[BZjrMtx0][Point]] *[n]* [[bpiXEe84][norm]] 
- @@latex:\phantomsection@@ *=Alpha=*  <<UHWJli9e>>
...
An enum
#+END_QUOTE
[[file:Foo.jl::31][Foo.jl:31]], [[KI1L4RUf][back to index]]
- @@latex:\phantomsection@@ *=Point=*  <<BZjrMtx0>> <<MCB54GqiPoint_struct>>
#+BEGIN_SRC julia :eval never :exports code
struct Point
#+END_SRC
#+BEGIN_QUOTE
...
in-documentation link, use [[MCB54Gqinorm_link_example][norm(...)]]
#+END_QUOTE
[[file:Foo.jl::8][Foo.jl:8]], [[KI1L4RUf][back to index]]
...
#+END_QUOTE
[[file:Foo.jl::27][Foo.jl:27]], [[KI1L4RUf][back to index]]
- @@latex:\phantomsection@@ *=norm=*  <<bpiXEe84>> <<MCB54Gqinorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
...
See: [[MCB54GqiPoint_struct][struct Point]]
#+END_QUOTE
[[file:Foo.jl::35][Foo.jl:35]], [[KI1L4RUf][back to index]]
:END:
