...
#+RESULTS:
:RESULTS:
<<fLiSFlTS>> *Index:* *[A]* [[aujIqHwV][Alpha]] *[P]* [[2o3fWj7f][Point]] *[n]* [[rZugUj3H][norm]] 
- @@latex:\phantomsection@@ *=Alpha=*  <<aujIqHwV>>
...
An enum
#+END_QUOTE
[[file:Foo.jl::31][Foo.jl:31]], [[fLiSFlTS][back to index]]
- @@latex:\phantomsection@@ *=Point=*  <<2o3fWj7f>> <<j9qQxEZ9Point_struct>>
#+BEGIN_SRC julia :eval never :exports code
struct Point
#+END_SRC
#+BEGIN_QUOTE
...
in-documentation link, use [[j9qQxEZ9norm_link_example][norm(...)]]
#+END_QUOTE
[[file:Foo.jl::8][Foo.jl:8]], [[fLiSFlTS][back to index]]
...
#+END_QUOTE
[[file:Foo.jl::27][Foo.jl:27]], [[fLiSFlTS][back to index]]
- @@latex:\phantomsection@@ *=norm=*  <<rZugUj3H>> <<j9qQxEZ9norm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
...
See: [[j9qQxEZ9Point_struct][struct Point]]
#+END_QUOTE
[[file:Foo.jl::35][Foo.jl:35]], [[fLiSFlTS][back to index]]
:END:
