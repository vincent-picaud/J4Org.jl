...
#+PROPERTY: header-args:jupyter-julia :session *julia__session* :exports both :eval no-export :results output drawer
#+OPTIONS: ^:{}
...
#+RESULTS:
:RESULTS:
<<iswrtjYL>> *Index:* *[A]* [[6vK0C255][Alpha]] *[P]* [[NGwPyLfF][Point]] *[n]* [[TH8j8Rwr][norm]] 
- @@latex:\phantomsection@@ *=Alpha=*  <<6vK0C255>>
...
An enum
#+END_QUOTE
[[file:Foo.jl::31][Foo.jl:31]], [[iswrtjYL][back to index]]
- @@latex:\phantomsection@@ *=Point=*  <<NGwPyLfF>> <<M1nU3BSxPoint_struct>>
#+BEGIN_SRC julia :eval never :exports code
struct Point
#+END_SRC
#+BEGIN_QUOTE
...
in-documentation link, use [[M1nU3BSxnorm_link_example][norm(...)]]
#+END_QUOTE
[[file:Foo.jl::8][Foo.jl:8]], [[iswrtjYL][back to index]]
...
#+END_QUOTE
[[file:Foo.jl::27][Foo.jl:27]], [[iswrtjYL][back to index]]
- @@latex:\phantomsection@@ *=norm=*  <<TH8j8Rwr>> <<M1nU3BSxnorm_link_example>>
#+BEGIN_SRC julia :eval never :exports code
...
See: [[M1nU3BSxPoint_struct][struct Point]]
#+END_QUOTE
[[file:Foo.jl::35][Foo.jl:35]], [[iswrtjYL][back to index]]
