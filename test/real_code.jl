...
@testset "real_code_with_link" begin
    ...
    @test s==" @@latex:\\phantomsection@@  <<foo>>\n#+BEGIN_SRC julia :eval never :exports code\nfoo()\n#+END_SRC\n#+BEGIN_QUOTE\nfoo\n[[foo][foo(...)]]\n[[foo2][foo2(...)]]\n_faa_\n[[faa][org]]\n\"[[foo][foo(...)]]\"\n#+END_QUOTE\n[[file:/home/picaud/.julia/v0.6/J4Org/test/code_examples/real_code_with_link.jl::1][real_code_with_link.jl:1]]\n @@latex:\\phantomsection@@  <<foo2>>\n#+BEGIN_SRC julia :eval never :exports code\nfoo2()\n#+END_SRC\n[[file:/home/picaud/.julia/v0.6/J4Org/test/code_examples/real_code_with_link.jl::10][real_code_with_link.jl:10]]\n"
end; 
